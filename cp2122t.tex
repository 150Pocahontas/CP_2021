...
\>[17]{}(\Varid{id}+\Varid{singl}\times\Varid{id})\comp \Varid{outNEList}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{minipage}}
\end{center}
...
\par Valorização:
\vspace{0.5cm}
\par Para descobrir o gene do anamorfismo \ensuremath{\Varid{pairList}} recorremos ao seu diagrama.
\vspace{0.5cm}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 pairsList}\mathrel{=}(\Varid{id}+\Varid{assocl})\comp (\Varid{id}+\Varid{id}\times\conj{\Varid{head}}{\Varid{tail}})\comp \Varid{outList}\comp \Varid{getEvenBlock}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{minipage}}
\end{center}
...
isto é a \ensuremath{\Conid{Merkle}\;\Conid{Root}}. Conhecendo o tipo da \ensuremath{\Varid{joinMerkleTree}} foi possivel aber o tipo do
lado direito do either, e assim obter o resto do diagrama.
\vspace{0.5cm}

\xymatrixcolsep{1pc}\xymatrixrowsep{5pc}
\centerline{\xymatrix{
    \mathbb{Z}^+ \ar[d]_-{\ensuremath{\cataList{\Varid{conquer}}\comp \anaList{\Varid{divide}}}}
                \ar [rr]^-{\ensuremath{\Varid{divide}}} & \quad \qquad
&   (FTree \mathbb{Z}\ \mathbb{Z})^+ + (FTree\ \mathbb{Z}\ \mathbb{Z})^+ \times\ \mathbb{Z}^+
          \ar[d]^{\ensuremath{\Varid{recNEList}\;(\cataList{\Varid{conquer}}\comp \anaList{\Varid{divide}})}}
\\
    FTree\ \mathbb{Z}\ \mathbb{Z} &
&   (FTree \mathbb{Z}\ \mathbb{Z})^+ + (FTree \mathbb{Z}\ \mathbb{Z})^+\ \times (FTree\ \mathbb{Z}\ \mathbb{Z})
          \ar[ll]^-{\ensuremath{\Varid{conquer}}}
}}

\vspace{0.5cm}
Distinto da primeira parte deste problema, em \ensuremath{{\FTree}\;\Varid{a}\;\Varid{c}} c corresponde ao valor de ache de uma folha, da \ensuremath{\Conid{Unit}}, e o a
...
\par Para o divide primeiro apliocamos o \ensuremath{\Varid{outNEList}}, para ficar com um tipo identico ao pretendido, precisando agora apenas de
...
\>[B]{}\Varid{classicMerkleTree}\mathrel{=}(\Varid{hyloNEList}\;\Varid{conquer}\;\Varid{divide})\comp (\map \;\Varid{\Conid{Main}.hash}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide}\mathrel{=}((\Varid{singl}\comp \Conid{Unit})+(\Conid{Comp}))\comp \Varid{outNEList}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g1}\mathrel{=}\Varid{nil}{}\<[E]%
\\
...
\\
\>[B]{}h_2 \;(\Varid{c},\Varid{l})\mathrel{=}\mathbf{if}\;(\Varid{sp}\;\Varid{c})\mathrel{\wedge}(\p2\;\Varid{l})\;\mathbf{then}\;(\p1\;\Varid{l}\mathbin{+}\mathrm{1})\;\mathbf{else}\;(\p1\;\Varid{l}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}k_1 \mathrel{=}\Conid{True}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{inX}\mathrel{=}\alt{\Conid{XLeaf}}{\Varid{n}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{n}\;(\Varid{i},(\Varid{l},\Varid{r}))\mathrel{=}\Conid{Node}\;\Varid{i}\;\Varid{l}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}(\Varid{id}+\Varid{assocl})\comp (\Varid{id}+\Varid{id}\times\conj{\Varid{head}}{\Varid{id}})\comp \Varid{outNEList}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Para conseguir chegar ao resutado de f2 precisamos primeiro de entender O que um mapa representa e como modifica-lo.
A primiera conclusão a que chegamos, pelo exemplo apresentado no problema 4 do Capitulo 1 da \ensuremath{\Varid{markMap}} é que a posição (0,0) a posição (0,1) a acima, ea posição (1,0) a da direita é a ultima linha da esquerda do mapa.
